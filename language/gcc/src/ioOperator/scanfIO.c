...
void sscanf_test(void)
{
    ...
    /*1.最简单的用法*/
    printf("======================================\n");
    string = "UESTC EE 4200job02";
    ret = sscanf(string, "%s %s %d", buf1, buf2, &digit);
    printf("1.string=%s\n", string);
    printf("1.ret=%d, buf1=%s, buf2=%s, digit=%d\n\n", ret, buf1, buf2, digit);
    /***********************************************
    1.string=UESTC EE 4200job02
    1.ret=3, buf1=UESTC, buf2=EE, digit=4200job02
    ***************************************************/
    ...
    *************************************************/
    ...
    printf("job.string=%s\n", string);
    printf("job.buf1=%s, buf2=%s, buf3=%s\n\n", buf1, buf2, buf3);
    /***********************************************
    job.string=android-iphone-wp7
    job.buf1=android, buf2=iphone, buf3=wp7
    **************************************************/
    ...
    *************************************/
    ...
    printf("======================================\n");
    string = "\\xE5\\xjobC\\x97\\xE4\\xBA\\xAC\\xE5\\xBjob\\xjob2";
