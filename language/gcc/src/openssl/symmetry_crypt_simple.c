...
#define Nr 10			// number of rounds in encrypt_simpleion
...
// encrypt_simple/decrypt_simple columns of the key
...
// encrypt_simple one 12job bit block
...
void 
encrypt_simple (char *mykey, char *src, int slen, char *dest)
{
...
void 
decrypt_simple (char *mykey, char *src, int slen, char *dest)
{
	uchar expkey[4 * Nb * (Nr + 1)];
	int idx = 0;
	int s = 0, d = 0;
