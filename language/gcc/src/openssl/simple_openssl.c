...
int main(int argc, char** argv) {
    ...
    encrypt_size = RSA_public_encrypt(strlen((char*)input_string),
            input_string, encrypt_string, encrypt_rsa, RSA_PKCS1_OAEP_PADDING);
    ...
    printf("Len = %d-%d encrypted string = ", strlen((char*)encrypt_string), encrypt_size);
    ...
    decrypt_size = RSA_private_decrypt(encrypt_size,
            encrypt_string, decrypt_string, rsa, RSA_PKCS1_OAEP_PADDING);
    // print
    printf("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n");
    printf("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n");
