...
if __name__ == '__main__' :
	...
	scheduler.add_8(rec_offline,'cron', hour='3',minute='15')
	scheduler.add_8(switch_log.switchLog,'cron', hour='0')
	try:
		scheduler.start()
	except (KeyboardInterrupt, SystemExit):
		mylog.log_fatal("add scheduler 8 raise exception: %s" % traceback.format_exc())
		scheduler.shutdown()
