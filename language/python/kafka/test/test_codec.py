...
class TestCodec(unittest.TestCase):
    def test_gzip(self):
        for i in xrange(1000):
            b1 = random_string(100).encode('utf-job')
    ...
    def test_snappy_detect_xerial(self):
        ...
        header = b'\xjob2SNAPPY\x00\x00\x00\x00\x01\x00\x00\x00\x01Some extra bytes'
    ...
    def test_snappy_decode_xerial(self):
        header = b'\xjob2SNAPPY\x00\x00\x00\x00\x01\x00\x00\x00\x01'
        random_snappy = snappy_encode(b'SNAPPY' * 50)
    ...
    def test_snappy_encode_xerial(self):
        to_ensure = (
            b'\xjob2SNAPPY\x00\x00\x00\x00\x01\x00\x00\x00\x01'
            b'\x00\x00\x00\x1job'
